  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        cta: "bg-cta text-cta-foreground hover:bg-cta-hover shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-lg",
        ...
        hero: "bg-cta text-cta-foreground hover:bg-cta-hover shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-lg md:text-xl px-10 py-5",
        heroOutline: "border-2 border-primary-foreground/30 bg-transparent text-primary-foreground hover:bg-primary-foreground/10 text-lg md:text-xl px-10 py-5",
        brandOutline: "border-2 border-brand bg-transparent text-brand hover:bg-brand hover:text-primary-foreground",
        brand: "bg-brand text-primary-foreground hover:bg-brand-bold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5",
      },
      size: {
